...
def qsort(S, m):
    ...
    def partition1(L, R):  # similar to partition0 but slightly optimized in speed,
        recurse()          # not in comparisons
        compares()
        if L >= R:
            return
        p = L
    ...
    def partition2(L, R):  # pivot is at center and lp & rp moves toward the center
        recurse()
        compares()
        if L >= R:
            return
    ...
    return comparison_counter, access_counter, recursion_counter
...
def main():
    ...
    L0 = list(range(5000000))  # 3010 max for method 0 & 1. 500000 max
    random.shuffle(L0)

    sys.setrecursionlimit(10000)

    types = ("Normal unsorted list sorting...",
             "Already sorted list sorting...", "Descending-sorted list sorting...")
    ...
    for method in range(starmethod, 3, 1):  # 3
        ...
        for listtype in range(0, 3, 1):  # 3
            ...
            print("\t{} compar., {} accesses, {} recurs., {} ms".format(
                c[0], c[1], c[2], t))
